...
if __name__ == "__main__":
    ...
    # Fix parent_high_edu and east_background to be dummies:
    for col in ["parent_high_edu", "east_background"]:
        if df[col].dtype == 'O' or df[col].dtype.name == 'category':
            ...
            # Append new dummy variable names to variable list later
            # We'll collect them here to extend the main vars list below
            ...
            # If numeric binary, keep as is and no dummy created
            if col == "parent_high_edu":
